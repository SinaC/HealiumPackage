...
local function Shared(self, unit)
	...
	health.value:SetFont(C["media"].uffont, 11*C["unitframes"].gridscale*T.raidscale, "THINOUTLINE")
	...
	name:SetPoint("LEFT") 
	name:SetPoint("RIGHT")
	name:SetFont(C["media"].uffont, 12*C["unitframes"].gridscale*T.raidscale)
...
oUF:Factory(function(self)
	...
	if C["unitframes"].gridonly ~= true then
		local raid = self:SpawnHeader("TukuiGrid", nil, "custom [@raid26,exists] show;hide",
