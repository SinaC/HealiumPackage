...
if H.client == "frFR" then
	...
	L.GREETING_VERSIONUNKNOWN = "Num\195\169ro de version non-disponible"
	L.GREETING_VERSION = "Version %s"
	L.GREETING_OPTIONS = "Utilisez /th pour obtenir une liste des commandes"
